...
#include "predicate_templates.hpp"
#include <cstring> //memcmp

template<typename... _Ty>
constexpr bool are_types_memcpy_safe_v = make_variadic_predicate< std::conjunction, std::is_trivially_copyable >::type<_Ty...>::value;
